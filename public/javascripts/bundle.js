...
var loadavg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loadavg'); //setInterval...第二引数で与えられた整数のミリ秒間隔で、第一引数の関数を実行する
// /server-status というパスに何のデータも渡さずにアクセスし、レスポンスが返ってきた際に実行する無名関数を設定

setInterval(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default().get('/server-status', {
    /* 何のデータも無名関数に渡さない */
  }, function (data) {
